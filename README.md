...
- `ai-daily-radar`：每日 AI 热点雷达。每天从国外 AI 社区、论文、开源项目、官方发布、技术资讯和 GitHub 快速增长 AI 工具库中收集最多 100 条候选，按推荐分和来源多样性输出 Top 50 Markdown 日报，包含英文标题、中文标题、推荐理由、热度、中文摘要、术语解释和源健康报告；支持可选 QQ 邮箱 SMTP 发送。
